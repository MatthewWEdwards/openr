...
extensions = [
    ...
    Extension(
        "openr.thrift.OpenrCtrlCpp.services",
        [
            "./openr-thrift/openr/if/gen-py3/openr/thrift/OpenrCtrlCpp/services.cpp",
            "openr-thrift/openr/if/gen-py3/OpenrCtrlCpp/services_wrapper.cpp",
        ],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ...
    Extension(
        "openr.thrift.OpenrCtrl.services",
        [
            "./openr-thrift/openr/if/gen-py3/openr/thrift/OpenrCtrl/services.cpp",
            "openr-thrift/openr/if/gen-py3/OpenrCtrl/services_wrapper.cpp",
        ],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ...
    Extension(
        "openr.thrift.Platform.services",
        [
            "./openr-thrift/openr/if/gen-py3/openr/thrift/Platform/services.cpp",
            "openr-thrift/openr/if/gen-py3/Platform/services_wrapper.cpp",
        ],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ...
    Extension(
        "fb303_core.clients",
        [
            "./fb303-thrift/fb303/thrift/gen-py3/fb303_core/clients.cpp",
            "./fb303-thrift/fb303/thrift/gen-py3/fb303_core/clients_wrapper.cpp"
        ],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ...
    Extension(
        "fb303_core.services",
        [
            "./fb303-thrift/fb303/thrift/gen-py3/fb303_core/services.cpp",
            "./fb303-thrift/fb303/thrift/gen-py3/fb303_core/services_wrapper.cpp"
        ],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
...
pydirs = ["/folly", "/thrift", "openr-thrift", "fbthrift-thrift", "fbzmq-thrift", "fb303-thrift"]
for p in pydirs:
    for root, _dirs, files in os.walk(p):
        for f in files:
            if f.endswith(".pyx"):
                pyx_file = os.path.join(root, f)
                module = re.sub(r".*gen-py3\.", "", pyx_file.replace(".pyx", "").replace("/", "."))
